...
* __blacklisted_strings__: Comma separated list of strings to look out for and ignore in download links. Useful when you want to ignore certain download sites. Defaults to empty string.
